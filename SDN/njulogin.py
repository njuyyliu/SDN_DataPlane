...
login = {
    'wang':{'username':'mg1633081', 'password':'2016njuwzl'},
}
...
if len(sys.argv) == 1:
    username = 'dg1833014' #raw_input("Input StudentID:")
    password = 'n20171012' #raw_input("Input Password:")
elif len(sys.argv) == 2:
    username = login[sys.argv[1]]['username']
    password = login[sys.argv[1]]['password']
